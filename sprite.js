...
function initSprites(img) {
    ...
    s_hero = [
        new Sprite(img, 223, 114, 17, 18),
        new Sprite(img, 223, 132, 18, 19),
        new Sprite(img, 223, 151, 17, 16),
        new Sprite(img, 223, 170, 15, 19),
        new Sprite(img, 223, 190, 15, 19),
        new Sprite(img, 223, 211, 10, 24)
    ];
